...
(defcustom smart-tab-using-auto-complete nil
  "Use `auto-complete' to expand text. Takes precedence over `smart-tab-using-hippie-expand'."
  :type '(choice
          (const :tag "auto-complete" t)
          (const :tag "other" nil))
  :group 'smart-tab)
...
the region or the current line (if the mark is not active)."
  ...
  (if (smart-tab-must-expand prefix)
      (if (and smart-tab-using-auto-complete auto-complete-mode)
          (auto-complete)
